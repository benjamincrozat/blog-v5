...
title: "The history of Laravel's versions (2011-2025)"
...
modified_at: 2025-07-05T09:15:00+02:00
serp_title: null
...
**The latest stable release of Laravel is version 12.** It's been publicly available since February 24, 2025. This version introduced numerous new features and changes. Laravel 12 will be supported until August 13, 2026 for bug fixes and until February 24, 2027 for security fixes.
...
- **Laravel 12**:
    - Laravel 12 is still the current version of the framework and receives weekly updates for new features, bug fixes, and security fixes.
- **Laravel 11**:
    - Laravel 11 is still supported and will receive bug fixes until September 3, 2025, and security fixes until March 12, 2026.
...
- **New Application Starter Kits**:
  - Brand-new React, Vue, and Livewire kits ship with Inertia 2, TypeScript, shadcn/ui (React/Vue) or Flux UI + Volt (Livewire), giving you production-ready auth, dashboards, and profile screens out of the box.
- **Optional WorkOS AuthKit Variant**:
  - Each kit offers a WorkOS flavour that adds social login, passkeys, and SSO, free for up to 1 million monthly active users.
- **Minimal-Impact Maintenance Release**:
  - 12.0 focuses on refreshing upstream dependencies while introducing as few breaking changes as possible, so most apps can upgrade in minutes.
- **PHP 8.2 Baseline Continues**:
