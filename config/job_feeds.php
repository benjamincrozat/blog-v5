...
return [
    ...
    [
        'name' => 'Remote OK (JavaScript)',
        'url' => 'https://remoteok.com/remote-javascript-jobs.rss',
        'enabled' => true,
        'max_items_per_run' => 20,
    ],
    [
        'name' => 'Remote OK (PHP)',
        'url' => 'https://remoteok.com/remote-php-jobs.rss',
        'enabled' => true,
        'max_items_per_run' => 20,
    ],
    [
        'name' => 'Remote OK (Laravel)',
        'url' => 'https://remoteok.com/remote-laravel-jobs.rss',
        'enabled' => true,
        'max_items_per_run' => 20,
    ],
    [
